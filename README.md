...
The original implementation remains at its original paths. Run it with `go run ./cmd/megatwist`.

The construction-kit version is in [dck/](dck/README.md). Run `go run ./dck/cmd/megatwist` from this directory. Both versions share the original assets.
